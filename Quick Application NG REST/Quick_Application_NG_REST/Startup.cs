...
using Quick_Application_NG_REST.Authorization;
using Quick_Application_NG_REST.Helpers;
using Quick_Application_NG_REST.ViewModels;
using Swashbuckle.AspNetCore.Swagger;
using System;
using AppPermissions = DAL.Core.ApplicationPermissions;

namespace Quick_Application_NG_REST
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("Quick_Application_NG_REST"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Quick_Application_NG_REST API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, ILogger<Startup> logger, IDatabaseInitializer databaseInitializer)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Quick_Application_NG_REST API V1");
            });
